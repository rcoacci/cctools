...
- If multiplier is positive, it should be greater or equal to 1.0, meaning that speculation occurs when the running time
  of the task becomes greater then average*multiplier (e.g. task is running for more than 1.6 times the average);
...
- When the multiplier is zero (backup tasks mode), priority is ignored.
- When the multiplier is greater that zero, priority should not be lower than regular tasks or the speculative
  tasks may be scheduled too late, defeating the purpose of speculation.
*/
